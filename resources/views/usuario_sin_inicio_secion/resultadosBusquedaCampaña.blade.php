                    ...
                    <tr>
                      ...
                      <td class="text-left p-t-15">
                        <div class="text-justify">
                            <div class="pull-left">
                              <img src="{{ asset('imagenes/imagenes_campañas/campañas_donaciones/donaciones_manos.jpg') }}" style="height: 120px; width: 200px" alt="">
                            </div>
                            <a   class="btn btn-primary pull-right m-b-30 m-l-30" href="#">ver</a>
          
                            <p class="total_propuestas_estilo_1">
                            <span class="total_propuestas_estilo_heading">Ayuda a los albergados de San Juan de Dios</span><br>

                            <font>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui rerum commodi minus, natus tempora in reprehenderit libero labore aspernatur alias architecto voluptatibus molestias maxime dolore dolorum. Harum voluptatem, incidunt expedita.</font><br>

                            <b><font >Fuente: </font></b>Mesas de Competitividad<br>

                            <font ><strong>Responsable: </strong>Daniel Naula</font><br>
