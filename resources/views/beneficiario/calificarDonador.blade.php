                  ...
                  <div class="row" style=" color: #348fe2;">
                      ...
                      <div class="toolbar title_ip_breadcrumb fit-m-b-10">
                        <ol class="breadcrumb">
                          ...
                          <li class="active"><a href="#">Calificar Donador</a></li>
                                  ...
                                  <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                      <p class="detalle-campaña">
                                              ...
                                              <strong class='text-success'> Vestimenta para adultos</strong><br>
                          ...
                          <!-- fin collapsible -->
                            <!-- inicio informacion general -->
                                <div class="panel panel-inverse" data-sortable-id="ui-typography-8">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">Calificación donador</h4>
                                        </div>
                                        <!-- inicio panel --> 
                                        <div class="panel-body">
                                           ...
                                           <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
                                             ...
                                             <div class="starability-growRotate">
                                              ...
                                              <div style="text-align: center;">
                                                <a type="submit" href="/mis-campañas/visualizar-donaciones" class="btn btn-primary">Registrar Calificación</a>
                                              </div>
                                           </form>
                                           <!-- fin form -->
