                        ...
                        <div class="col-md-3">
                            <!-- inicio informacion general -->
                                <div class="panel panel-inverse" data-sortable-id="ui-typography-8">
                                        ...
                                        <div class="panel-body">
                                          <h5 class="panel-title alert subtitulo-info-general fade in m-b-15"><strong>Codigo campaña:</strong></h5>
                                          <p class="informacion-campaña">
                                          3
                                          </p>
                                         <h5 class="panel-title alert subtitulo-info-general fade in m-b-15"><strong>Título Campaña:</strong></h5>
                                         <p class="informacion-campaña">
                                          Ayuda a los ancianos del albergue San Juan de Dios
                                        </p>
                                        
                                        <h5 class="panel-title alert subtitulo-info-general fade in m-b-15"><strong>Descripción corta:</strong></h5>
                                         <p class="informacion-campaña">
                                          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam perferendis voluptate laboriosam veritatis blanditiis similique inventore recusandae deserunt ex culpa quia quas molestiae delectus maiores, aut neque consequuntur, tempore quidem.
                                        </p>
                                        <h5 class="panel-title alert subtitulo-info-general fade in m-b-15"><strong>Tipo Campaña:</strong></h5>
                                        <p class="informacion-campaña">
                                          Donaciones de bienes
                                        </p>
                                        <h5 class="panel-title alert subtitulo-info-general fade in m-b-15"><strong>Creador:</strong></h5>
                                        <p class="informacion-campaña">
                                          Daniel Jesús Naula Guiñan
                                        </p>
